...
function modifierNotice(ancienPpn)
{
	...
	supprimerRemplacer("214","214 #2$aLille$cAtelier national de reproduction des th\u00e8ses$dAnnee de diffusion");
	modifier328();
	//ajouter("455 ##$t@Lien vers la these imprime, document originel");
