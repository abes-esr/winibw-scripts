/**
	Convertir un caractére unicode ALA en un caractére unicode ISO 9.<b> 
	Les formes composées sont préférées pour les caractéres ISO.
	
	
	Version pour l'Arabe
*/
// mis é jour le 2018-05-31 par SRY : ajout zone 219
...
function convertirCaractereAlaVersIso (caract)
{
	switch (caract)
	{
		...
		case "\u0069\u00AF\u0079\u0061\u0074\u007D" : return "\u0069\u0079\u0079\u0061\u1E97\u007D";
		case "\u0069\u00AF\u0079\u0061\u0074\u0024" : return "\u0069\u0079\u0079\u0061\u1E97\u0024";
        //i macron y a t                 :       i y y a t+tréma 
		...
		case "\u0001" : return "";
		// supprime le caractére qui sert é repérer la fin de ligne (utilisé pour les cas ci-dessus).
		default : return "\u0000";
	}
}
/**
	Renvoie les zones é traiter définies par défaut.
*/
...
/**
	Renvoie les zones é traiter choisies par l'utilisateur
*/
...
/**
	Convertir la chaéne passée en paramétre de l'unicode ALA vers les 
	caractéres de l'unicode ISO 9.
*/
function convertirChaineAlaVersIso (chaine)
{
	
	// tests avec substr
	// tant que chaine.length >0, envoyer toute la chaine , puis toute la chaéne -1, puis -2 
	...
	// si chaine.length =0 et res = rien, alors le caract reste le méme.
	// caractPrec permet de ne pas convertir si le caractére précédant celui en cours
...
/**
	Vérifie si la zone passée en paramétre doit étre convertie.
...
/**
	...
	é convertir : é gauche du choix = non converti, é droite = converti.
*/
...
/** 	Passe en revue toute les zones /zone/ de la notice, et 
	...
	ex : - premiére zone 517 (i = 0)
		 - deuxiéme zone 517 (i = 1) etc. jusqu'é res == ""
*/
function convertirZone (zone, application)
{
	...
	do
	{
		...
		{
			res += "\u0001";// ajout d'un caractére qui sert é identifier la fin de la ligne
