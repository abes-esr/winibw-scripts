...
function remplacerValeurZone700(tag) {
	...
	while (res != "") {
		...
		//on recup�re le contenu de la zone sans le libelle de la $4 :
		//l'index de fin est situe � la position de la $4 + 2 caract�res de la sous zone + 3 caract�res du code de fonction
