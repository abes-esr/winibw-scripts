...
{// affiche les mises � jour (creation, modification, suppression) de tout le reseau sur les notices autorite (AUJ ou periode).
...
{// affiche la liste des notices localisees par la biblioth�que indiquee. Il est possible d'affiner la recherche avec d'autres index ou des limitations.
...
function CTL_dedUnm ()
{// affiche les notices doublons liees par une zone 024 (commande sous contr�le des dedoublonneurs locaux)
